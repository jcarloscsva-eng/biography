...
// ── CLIENT LOGOS ──
  ...
  const translations = {
    en: {
      ...
      'nav-cv': 'View CV →',
      // Hero
      'hero-eyebrow': 'Senior Project & Program Manager · Enterprise SaaS Delivery · EMEA · 15+ Years',
      ...
      'about-text-1': 'I don\'t just manage projects — I <strong>help build the infrastructure that makes great delivery possible</strong>. Delivery governance, onboarding functions, reporting frameworks, escalation paths — I design and implement them, and make sure they outlast my involvement.',
      'about-text-2': 'My background in computer science means I speak fluently with engineers, architects, and technical teams. I take part in technical decisions, not as an observer but as a contributor — giving my teams confidence and clarity when the complexity is highest, and challenging assumptions to keep the programme on track.',
      ...
      'about-text-4': 'This is backed by formal certification: PMP®, Google Project Management, and Google Agile Project Management.',
      ...
      'card-5-desc': 'With a computer science background and three years leading a team of Solution and Technical Architects, I bridge business requirements and technical execution. I work directly with architects and engineers, challenge technical approaches, translate complex client needs into delivery plans and coordinate technical dependencies. My teams deliver better because I understand what they\'re building.',
      ...
      'contact-sub': 'Available for Senior Project Manager, Program Manager, Technical Program Manager and Delivery Manager roles across EMEA — based in Valladolid, available for hybrid work in Madrid and open to remote.',
    ...
    es: {
      ...
      'nav-cv': 'Ver CV →',
      'hero-eyebrow': 'Senior Project & Program Manager · Entrega SaaS Enterprise · EMEA · +15 Años',
      ...
      'about-text-1': 'No me limito a gestionar proyectos — <strong>ayudo a construir la infraestructura que hace posible una entrega excelente</strong>. Gobernanza de entrega, funciones de onboarding, marcos de reporting, protocolos de escalado — los diseño e implemento y me aseguro de que sigan funcionando cuando ya no estoy.',
      'about-text-2': 'Mi formación en informática me permite hablar con fluidez con ingenieros, arquitectos y equipos técnicos. Participo en las decisiones técnicas del proyecto, no como observador sino como contribuidor — aportando confianza y claridad al equipo en los momentos de mayor complejidad y cuestionando supuestos para mantener el programa en rumbo.',
      ...
      'about-text-4': 'Esto se apoya en formación certificada: PMP®, Google Project Management y Google Agile Project Management.',
      ...
      'card-5-desc': 'Con formación en informática y tres años liderando un equipo de Solution y Technical Architects, soy el puente entre los requisitos de negocio y la ejecución técnica. Trabajo directamente con arquitectos e ingenieros, cuestiono los enfoques técnicos, traduzco necesidades complejas del cliente en planes de entrega y coordino las dependencias técnicas. Mis equipos entregan mejor porque entiendo lo que están construyendo.',
      ...
      'contact-sub': 'Disponible para roles de Senior Project Manager, Program Manager, Technical Program Manager y Delivery Manager en EMEA — con base en Valladolid, disponible para trabajo híbrido en Madrid y abierto a remoto.',
