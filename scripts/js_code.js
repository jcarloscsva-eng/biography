...
// ── CLIENT LOGOS ──
  ...
  const translations = {
    en: {
      ...
      'nav-stories': 'Delivery Stories',
      'nav-career': 'Career',
      'nav-contact': 'Contact',
      'nav-cv': 'View CV →',
      // Hero
      'hero-eyebrow': 'Senior Project · Program · Delivery Manager · EMEA',
      'hero-credentials': 'PMP® · Google Project Management Certified · Google Agile Certified',
      'hero-subtitle': 'I lead complex enterprise SaaS programmes across EMEA, bringing structure to ambiguity and alignment to cross-functional teams.<br><br>For more than 15 years, I have worked at the point where client priorities, technical constraints and delivery risk meet — from discovery and governance through go-live, stabilisation and measurable value.',
      'scroll-hint': 'Metrics',
      'cta-contact': 'Discuss a role',
      'cta-cv': 'View Full CV',
      ...
      'metric-4-label': 'Cross-regional delivery<br>for enterprise organisations',
      'metric-5-label': 'SaaS implementations delivered<br>across complex programmes',
      ...
      'about-text-1': 'I combine hands-on programme leadership with the operating structure that supports reliable delivery. That includes governance, onboarding functions, reporting frameworks and escalation paths designed to remain useful beyond a single project.',
      'about-text-2': 'My computer science background helps me work effectively with engineers, architects and technical teams. I translate between business outcomes and technical constraints, ask informed questions and turn decisions and dependencies into clear delivery plans.',
      'about-text-3': 'I have led high-risk enterprise SaaS programmes across EMEA, including work requiring programme recovery, stakeholder realignment and cross-regional coordination. My approach is direct: surface risk early, make ownership explicit and keep communication honest.',
      'about-text-4': 'My experience is supported by PMP®, Google Project Management and Google Agile Project Management certifications.',
      'clients-label': 'Successful engagements',
      // Expertise
      'section-tag-expertise': 'What I bring',
      'expertise-heading': 'Six areas of<br>delivery leadership',
      'card-1-title': 'Enterprise SaaS Delivery',
      'card-1-desc': 'I take end-to-end ownership of complex, multi-stakeholder implementations, from discovery through go-live and post-launch stabilisation, with clear accountability throughout.',
      'card-2-title': 'PMO Design & Governance',
      'card-2-desc': 'I co-built the client delivery function in Spain alongside the Country Delivery Manager, contributing governance standards, KPI and reporting frameworks and change-control processes later adopted across EMEA. Certified in PMP, Google Project Management, and Google Agile Project Management.',
      ...
      'card-4-desc': 'I manage delivery across EMEA time zones, cultures and stakeholder layers, adapting communication for executive presentations and technical deep-dives with engineering teams.',
      'card-5-title': 'Solution Architecture & Technical Leadership',
      'card-5-desc': 'With a computer science background and three years leading a team of Solution and Technical Architects, I bridge business requirements and technical execution. I work directly with architects and engineers, question technical approaches, translate complex client needs into delivery plans and coordinate dependencies.',
      'card-6-title': 'AI-Augmented Delivery',
      'card-6-desc': 'I use AI in day-to-day delivery work to review emerging risks, support performance reporting and sharpen client communications. Beyond PM tooling, I build automations with n8n, develop custom chatbots and am completing formal training in AI concepts, trends and workflow automation.',
      // Selected delivery stories
      'section-tag-stories': 'Selected delivery stories',
      'stories-heading': 'How I lead when<br><em>delivery gets difficult</em>',
      'stories-intro': 'Brief, anonymised examples of the problems I was asked to solve, the decisions I made and what changed.',
      'story-1-category': 'Global FMCG company',
      'story-1-title': 'Rebuilding trust after a failed campaign',
      'story-1-problem': '<strong>Challenge:</strong> A previous campaign had failed and damaged the client\'s confidence ahead of a new strategic launch.',
      'story-1-action': '<strong>Intervention:</strong> I aligned client and internal teams, strengthened quality assurance and introduced closer launch monitoring.',
      'story-1-impact': '<strong>Impact:</strong> The campaign launched on time and client confidence was renewed.',
      'story-2-category': 'Global sports organisation',
      'story-2-title': 'Building support for a platform migration',
      'story-2-problem': '<strong>Challenge:</strong> A key CRM stakeholder preferred the incumbent provider and was resistant to the change.',
      'story-2-action': '<strong>Intervention:</strong> I worked directly with the stakeholder to understand the concerns and incorporated them into the delivery approach.',
      'story-2-impact': '<strong>Impact:</strong> The migration was completed with stakeholder support.',
      'story-3-category': 'Hospitality group',
      'story-3-title': 'Delivering a first-of-its-kind regional solution',
      'story-3-problem': '<strong>Challenge:</strong> The EMEA team was implementing a wallet solution it had not delivered before, and regional technical knowledge became a constraint.',
      'story-3-action': '<strong>Intervention:</strong> I brought in expertise from other regions and worked hands-on with the technical team to coordinate the unfamiliar dependencies.',
      'story-3-impact': '<strong>Impact:</strong> The regional implementation moved forward with the specialist support needed to deliver it.',
      'stories-cta': 'Discuss how I approach complex delivery →',
      ...
      'tl-1-desc': 'I led EMEA\'s highest-risk enterprise SaaS programmes, contributing to standardised delivery governance and change control across the region. I managed concurrent programmes for PepsiCo, Arsenal FC, Hiscox, Aviva Ireland and Kraft Heinz.',
      ...
      'contact-sub': 'Open to Senior Project, Program, Technical Program and Delivery Manager opportunities across EMEA — based in Valladolid, available for hybrid work in Madrid and open to remote roles.',
      ...
      'footer-stories': 'Delivery Stories',
    ...
    es: {
      ...
      'nav-stories': 'Casos de entrega',
      'nav-career': 'Trayectoria',
      'nav-contact': 'Contacto',
      'nav-cv': 'Ver CV →',
      'hero-eyebrow': 'Senior Project · Program · Delivery Manager · EMEA',
      'hero-credentials': 'PMP® · Certificación Google Project Management · Certificación Google Agile',
      'hero-subtitle': 'Lidero programas SaaS enterprise complejos en EMEA, aportando estructura ante la ambigüedad y alineando equipos multidisciplinares.<br><br>Durante más de 15 años he trabajado en el punto de encuentro entre las prioridades del cliente, las restricciones técnicas y el riesgo de entrega: desde el discovery y la gobernanza hasta el go-live, la estabilización y el valor medible.',
      'scroll-hint': 'Métricas',
      'cta-contact': 'Hablar sobre un rol',
      ...
      'metric-4-label': 'Entrega multinacional<br>para organizaciones enterprise',
      'metric-5-label': 'Implementaciones SaaS entregadas<br>en programas complejos',
      ...
      'about-text-1': 'Combino un liderazgo práctico de programas con la estructura operativa que facilita una entrega fiable. Esto incluye gobernanza, funciones de onboarding, marcos de reporting y vías de escalado diseñadas para seguir siendo útiles más allá de un único proyecto.',
      'about-text-2': 'Mi formación en informática me ayuda a trabajar eficazmente con ingenieros, arquitectos y equipos técnicos. Traduzco entre resultados de negocio y restricciones técnicas, formulo preguntas informadas y convierto decisiones y dependencias en planes de entrega claros.',
      'about-text-3': 'He liderado programas SaaS enterprise de alto riesgo en EMEA, incluyendo recuperaciones de programas, realineamiento de stakeholders y coordinación multinacional. Mi enfoque es directo: anticipar los riesgos, hacer explícita la responsabilidad y mantener una comunicación honesta.',
      'about-text-4': 'Mi experiencia está respaldada por las certificaciones PMP®, Google Project Management y Google Agile Project Management.',
      'clients-label': 'Proyectos completados con éxito',
      'section-tag-expertise': 'Mi propuesta de valor',
      'expertise-heading': 'Seis áreas de<br>liderazgo en entrega',
      'card-1-title': 'Entrega SaaS Enterprise',
      'card-1-desc': 'Asumo la responsabilidad end-to-end de implementaciones complejas con múltiples stakeholders, desde el discovery hasta el go-live y la estabilización post-lanzamiento, con accountability clara en todo el proceso.',
      'card-2-title': 'Diseño de PMO y Gobernanza',
      'card-2-desc': 'Co-construí la función de entrega de clientes en España junto al Country Delivery Manager, aportando estándares de gobernanza, marcos de KPI y reporting y procesos de control de cambios adoptados después en EMEA. Certificado en PMP, Google Project Management y Google Agile Project Management.',
      ...
      'card-4-desc': 'Gestiono entregas en distintas zonas horarias, culturas y niveles de stakeholders en EMEA, adaptando la comunicación para presentaciones ejecutivas y sesiones técnicas con equipos de ingeniería.',
      'card-5-title': 'Arquitectura de Solución y Liderazgo Técnico',
      'card-5-desc': 'Con formación en informática y tres años liderando un equipo de Solution y Technical Architects, conecto los requisitos de negocio con la ejecución técnica. Trabajo directamente con arquitectos e ingenieros, cuestiono los enfoques técnicos, traduzco necesidades complejas del cliente en planes de entrega y coordino dependencias.',
      'card-6-title': 'Entrega Potenciada por IA',
      'card-6-desc': 'Utilizo IA en el trabajo diario de entrega para revisar riesgos emergentes, apoyar el reporting de rendimiento y mejorar las comunicaciones con clientes. Además de las herramientas de PM, creo automatizaciones con n8n, desarrollo chatbots personalizados y completo formación especializada en conceptos, tendencias y automatización de flujos de trabajo con IA.',
      'section-tag-stories': 'Casos de entrega seleccionados',
      'stories-heading': 'Cómo lidero cuando<br><em>la entrega se complica</em>',
      'stories-intro': 'Ejemplos breves y anonimizados de los problemas que debía resolver, las decisiones que tomé y lo que cambió.',
      'story-1-category': 'Empresa global de gran consumo',
      'story-1-title': 'Recuperar la confianza tras una campaña fallida',
      'story-1-problem': '<strong>Reto:</strong> Una campaña anterior había fallado y afectado a la confianza del cliente antes de un nuevo lanzamiento estratégico.',
      'story-1-action': '<strong>Intervención:</strong> Alineé a los equipos del cliente y los equipos internos, reforcé el control de calidad e introduje un seguimiento más estrecho del lanzamiento.',
      'story-1-impact': '<strong>Impacto:</strong> La campaña se lanzó a tiempo y se recuperó la confianza del cliente.',
      'story-2-category': 'Organización deportiva global',
      'story-2-title': 'Conseguir apoyo para una migración de plataforma',
      'story-2-problem': '<strong>Reto:</strong> Un stakeholder clave de CRM prefería al proveedor anterior y se resistía al cambio.',
      'story-2-action': '<strong>Intervención:</strong> Trabajé directamente con él para entender sus preocupaciones y las incorporé al enfoque de entrega.',
      'story-2-impact': '<strong>Impacto:</strong> La migración se completó con el respaldo del stakeholder.',
      'story-3-category': 'Grupo hotelero',
      'story-3-title': 'Entregar una solución regional sin precedentes',
      'story-3-problem': '<strong>Reto:</strong> El equipo de EMEA estaba implantando una solución wallet que no había entregado antes y el conocimiento técnico regional se convirtió en una limitación.',
      'story-3-action': '<strong>Intervención:</strong> Incorporé experiencia de otras regiones y trabajé directamente con el equipo técnico para coordinar dependencias desconocidas.',
      'story-3-impact': '<strong>Impacto:</strong> La implantación regional avanzó con el apoyo especializado necesario para entregarla.',
      'stories-cta': 'Hablemos sobre cómo gestiono entregas complejas →',
      'section-tag-career': 'Trayectoria',
      'career-heading': 'Una progresión basada<br>en <em>resultados</em>',
      'tl-1-period': 'Ene 2022 – Feb 2026',
      'tl-1-role': 'Lead Project Manager, EMEA',
      'tl-1-desc': 'Lideré los programas SaaS enterprise de mayor riesgo en EMEA, contribuyendo a una gobernanza de entrega y un control de cambios estandarizados en la región. Gestioné programas concurrentes para PepsiCo, Arsenal FC, Hiscox, Aviva Ireland y Kraft Heinz.',
      ...
      'contact-sub': 'Abierto a oportunidades como Senior Project, Program, Technical Program y Delivery Manager en EMEA — con base en Valladolid, disponible para trabajo híbrido en Madrid y posiciones remotas.',
      ...
      'footer-stories': 'Casos de entrega',
  ...
  function setLang(lang) {
    ...
    document.querySelectorAll('[data-t]').forEach(el => {
        ...
        if (translation) {
            ...
            else if (key.includes('subtitle') || key.includes('heading') || key.includes('text') || key.includes('label') || key.includes('rec-') || key.includes('story-')) {
    ...
    const fullCvUrl = isEs ? 'CV_JuanCarlosCastillo_SeniorProjectManager_ES.html' : 'CV_JuanCarlosCastillo_SeniorProjectManager_EN.html';
  ...
  // ── LÓGICA DE INICIO DE TEMA (ANTI-PARPADEO) ──
  (function initTheme() {
    let isLight = false; // Oscuro por defecto
