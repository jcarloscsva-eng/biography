...
// ── CLIENT LOGOS ──
  ...
  const translations = {
    en: {
      ...
      'card-2-desc': 'I built PMO frameworks at Marigold that were adopted globally. I design governance standards, risk models, KPI frameworks and reporting structures that create delivery consistency at scale. Certified in PMP, Google Project Management, and Google Agile Project Management.',
    ...
    es: {
      ...
      'card-2-desc': 'Construí marcos PMO en Marigold que fueron adoptados globalmente. Diseño estándares de gobernanza, modelos de riesgo, marcos de KPI y estructuras de reporting que crean consistencia en la entrega a escala. Certificado en PMP, Google Project Management y Google Agile Project Management.',
